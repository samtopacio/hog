    ...
    def say(score0, score1):
        ...
        if who == 0:
            ...
            if gain > oh:
                oh = gain
                if gain == 1:
                    print(gain, "point! That's the biggest gain yet for Player 0")
                else:    
                    print(gain, "points! That's the biggest gain yet for Player 0")
            os = score0
        elif who == 1:
            gain = score1 - os
            if gain > oh:
                oh = gain
                if gain == 1:
                    print(gain, "point! That's the biggest gain yet for Player 1")
                else:    
                    print(gain, "points! That's the biggest gain yet for Player 1")
            os = score1
        return announce_highest(who, oh, os)
    return say
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    max_avg, max_earn, a = 1, 0, 1
    while a <= 10:
       b = make_averaged(roll_dice, num_samples)(a, dice)
       if b > max_avg:
           max_avg, max_earn = b, a
       a += 1
    return max_earn 
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    if opponent_score % (free_bacon(opponent_score) + score) == 0:
        return 0
